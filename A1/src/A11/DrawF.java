    ...
    public static void main(String[] args) {
       //Checking for input errors
        ...
        switch (M)
        {
            ...
            case "w":
                try {
                    //Here I print the F in the console and store it in the ByteArrayOutputStream while flushing the console output so it doesn't show
                    ...
                    System.out.flush();
                    System.setOut(old);
                    //Brought back the original console output and print the output with the F as a string in the window
