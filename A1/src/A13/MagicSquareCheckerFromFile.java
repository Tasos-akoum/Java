    ...
    private static int[][] readFile(File file)
    {
        try {
            ...
            while (br.readLine() != null) {
                lines++; //Check to see how many lines are in the file and use it to initialize the array as it is of the form line * line
            }
            ...
            while((row = br.readLine()) != null)
            {
                ...
                if(data.length != lines) //If a column is not the same size as the lines it is not n * n
                {
            ...
            if(folder != null && folder.exists())
            {
                try {
                    ...
                    for(int i = 0; i < square.length; i++)
                    {
                        ...
                        {
                            writer.write(square[i][j] + ", "); //Write the array to the file
                        }
                        writer.write("\n");
                    }
